...
function BrandHome() {
  ...
  else if (brandState.status ==='rejected')
  {
    ...
    <tbody>
    {brandState.brands && brandState.brands.map((brand) => (
    ...
    <td>
      ...
      {brand.image ? (
        <img src={brand.image.secure_url} alt='brand logo' style={{ maxWidth: '100px' }}/>
...
<div style={{ display: 'flex', alignItems: 'center' }}>
    ...
    <Link to={`/BrandUpdate/${brand._id}`} className='btn btn-sm btn-primary'>Edit</Link>
